export default () => ({
    'strapi-cache': {
        ...
        config: {
            ...
            redisConfig: 'redis://localhost:6379', // Redis config takes either a string or an object see https://github.com/redis/ioredis for references to what object is available, the object or string is passed directly to ioredis client (if using Redis)
